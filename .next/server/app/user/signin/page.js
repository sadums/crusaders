...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 517)), "C:\\Users\\Jon\\OneDrive\\desktop\\Coding\\Projects\\Project-3\\app\\user\\signin\\page.tsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8348)), "C:\\Users\\Jon\\OneDrive\\desktop\\Coding\\Projects\\Project-3\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["C:\\Users\\Jon\\OneDrive\\desktop\\Coding\\Projects\\Project-3\\app\\user\\signin\\page.tsx"];

    

    const originalPathname = "/user/signin/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/user/signin/page","pathname":"/user/signin","bundlePath":"app/user/signin/page","filename":"","appPaths":[]}}
...
var __webpack_exports__ = __webpack_require__.X(0, [669,322,684], () => (__webpack_exec__(6081)));
