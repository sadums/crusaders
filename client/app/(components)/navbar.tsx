...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
                  ...
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    <div className="relative grid gap-6 dark:bg-neutral-900 px-5 py-6 sm:gap-8 sm:p-8">
                      ...
                      >
                        ...
                        <div className="ml-4">
                          <p className="text-base font-medium text-gray-900 dark:text-gray-500">
                            Analytics
                          </p>
                    ...
                    <div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8 dark:bg-neutral-900">
            ...
            */}{" "}
                ...
                >
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8 dark:bg-neutral-900">
                      <div>
    ...
    */}
        ...
        >
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-neutral-900 divide-y-2 divide-gray-50 bg-neutral-100">
            <div className="pt-5 pb-6 px-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <img className="h-8 w-auto" src="/logo.svg" alt="Workflow" />
                  <h2 className="font-lg text-gray-600 dark:text-gray-500 text-3xl font-mono">
                    Title
                  </h2>
                </div>
                <div className="-mr-2">
