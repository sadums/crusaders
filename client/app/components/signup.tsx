...
const SignUpModal: React.FC<SignInModalProps> = ({ setIsSignUpModalOpen }) => {
  ...
  const handleSignUp = async (event: React.FormEvent) => {
    ...
    const firstNameValue = target.form[2].value
    const lastNameValue = target.form[3].value
    const passwordValue = target.form[4].value;
    const confirmPasswordValue = target.form[5].value;
